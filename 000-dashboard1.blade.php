@extends('layout.002-top-menu')
@extends('layout.001-menu1')
                        ...
                        <div class="card bg-analytics text-white">
                            <div class="card-content">
                                <div class="card-body text-center">
                                    <img src="/assets/images/elements/decore-left.png" class="img-left"
                                        alt="
        card-img-left">
                                    <img src="/assets/images/elements/decore-right.png" class="img-right"
                                        alt="
        card-img-right">
